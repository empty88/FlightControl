...
#define LOGICAL_MIN16	_LOGICAL_MIN(2)
#define LOGICAL_MAX 	_LOGICAL_MAX(1)
#define LOGICAL_MAX16	_LOGICAL_MAX(2)
...
//LOCAL ITEMS
#define _USAGE(size) 			      (0x08 | size)
#define _USAGE_MIN(size) 		    (0x18 | size)
#define _USAGE_MAX(size) 		    (0x28 | size)
#define _DESIGNATOR_INDEX(size) (0x38 | size)
#define _DESIGNATOR_MIN(size) 	(0x48 | size)
#define _DESIGNATOR_MAX(size) 	(0x58 | size)
#define _STRING_INDEX(size) 	  (0x78 | size)
#define _STRING_MIN(size) 		  (0x88 | size)
#define _STRING_MAX(size) 		  (0x98 | size)
#define _DELIMITER(size) 		    (0xA8 | size)
